...
all_phenophase_info = data_frame(Phenophase_ID = c(371,501,498, 390),
                                 noun = c('leaf','flower','fall color', 'ripe fruit'),
                                 noun_plural = c('leaves','flowers','fall colors', 'ripe fruits'),
                                 verb = c('leaf out','flowering','fall coloring', 'ripe fruits'))
